...
int main(int argc, char **argv){
  ...
  if(pthread_create(&send_msg_thread, NULL, (void *) send_msg_handler, (void*)buff_client) != 0){
		printf("ERROR: pthread\n");
    return EXIT_FAILURE;
	}

	pthread_t recv_msg_thread;
  if(pthread_create(&recv_msg_thread, NULL, (void *) recv_msg_handler, (void*)buff_client) != 0){
		printf("ERROR: pthread\n");
		return EXIT_FAILURE;
	}
